...
const Buttongroup = () => {
  return (
    <div className="grid grid-cols-4 w-full pt-2 ">
      ...
      >
        <div className="flex flex-col justify-center items-center h-10 w-10 rounded-full bg-gray-100 ">
          <svg
      ...
      >
        ...
        <p className="font-bold text-sm text-center">Rewards</p>
      </Link>
      {/* User Center */}
      <Link
        href="/usercenter"
      ...
      >
        ...
        <p className="font-bold text-sm text-center">Profile</p>
      </Link>
    </div>
  );
};
