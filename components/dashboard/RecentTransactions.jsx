...
const RecentTransactions = () => {
  ...
  useEffect(() => {
    const fetchUserDetails = async () => {
      ...
      const res = await fetch("https://binaryp2psytes.net/api/wallet/getBscWallet", {
        method: "POST",
  ...
  const saveTransactions = async (transactions, address) => {
    ...
    await fetch("https://binaryp2psytes.net/api/wallet/saveTransactions", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
  ...
  useEffect(() => {
    const fetchUserTransactions = async () => {
      ...
      try {
        const res = await fetch("https://binaryp2psytes.net/api/wallet/getUserTransactions", {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({ email: userEmail }),
        });
